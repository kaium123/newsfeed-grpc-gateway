...
func (uc *UserCreate) AddAttachmentIDs(ids ...int) *UserCreate {
...
func (uc *UserCreate) AddReactedUserIDs(ids ...int) *UserCreate {
	uc.mutation.AddReactedUserIDs(ids...)
	return uc
}

// AddReactedUser adds the "reacted_user" edges to the React entity.
func (uc *UserCreate) AddReactedUser(r ...*React) *UserCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return uc.AddReactedUserIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.ReactedUserIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
