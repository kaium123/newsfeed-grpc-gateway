...
type UserEdges struct {
	...
	ReactedUser []*React `json:"reacted_user,omitempty"`
...
// was not loaded in eager-loading.
func (e UserEdges) ReactedUserOrErr() ([]*React, error) {
	if e.loadedTypes[2] {
...
// QueryReactedUser queries the "reacted_user" edge of the User entity.
func (u *User) QueryReactedUser() *ReactQuery {
	return NewUserClient(u.config).QueryReactedUser(u)
}
